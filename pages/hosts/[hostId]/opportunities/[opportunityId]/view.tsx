...
const OpportunityViewPage = ({ hostId, opportunityId }: { hostId: string, opportunityId: string }) => {
  ...
  const transformedOpportunity = useMemo(() => {
    ...
    return {
      ...
      workTimeSettings: {
        hoursPerDay: opportunity.workTimeSettings?.workHoursPerDay || 0,
        daysPerWeek: opportunity.workTimeSettings?.workDaysPerWeek || 0,
        minimumStay: opportunity.workTimeSettings?.minimumStay || null,
